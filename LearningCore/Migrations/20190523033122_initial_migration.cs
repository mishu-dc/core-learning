        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LinkedinLink = table.Column<string>(maxLength: 500, nullable: true),
                    FaceBookLink = table.Column<string>(maxLength: 500, nullable: true),
                    GitHubLink = table.Column<string>(maxLength: 500, nullable: true),
                    LeetCodeLink = table.Column<string>(maxLength: 500, nullable: true),
                    Address = table.Column<string>(maxLength: 500, nullable: false),
                    Email = table.Column<string>(maxLength: 100, nullable: false),
                    Phone = table.Column<string>(maxLength: 500, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IssueingAuthority = table.Column<string>(maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UniversityName = table.Column<string>(maxLength: 500, nullable: false),
                    UniversityLink = table.Column<string>(maxLength: 500, nullable: false),
                    PassingYear = table.Column<int>(nullable: true),
                    UniversityAddress = table.Column<string>(maxLength: 500, nullable: false),
                    Serial = table.Column<int>(nullable: false),
                    ProfileId = table.Column<int>(nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsCurrent = table.Column<bool>(nullable: false, defaultValue: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Experiences_Profile_ProfileId",
                        column: x => x.ProfileId,
                        principalTable: "Profile",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DemoLink = table.Column<string>(maxLength: 500, nullable: true),
                    GitHubLink = table.Column<string>(maxLength: 500, nullable: true),
                    Serial = table.Column<int>(nullable: false),
                    ProfileId = table.Column<int>(nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Publications_Profile_ProfileId",
                        column: x => x.ProfileId,
                        principalTable: "Profile",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
